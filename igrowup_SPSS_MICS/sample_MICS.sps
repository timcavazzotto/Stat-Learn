...
Report
  ...
  MARGINS(1,61)
  /TITLE=
   LEFT 'sample_MICS using WHO Child Growth Standards'
  /VARIABLES
...
Report
  ...
  PAGE(1) MISSING'.' LENGTH(1, 99999)ALIGN(LEFT) TSPACE(0) FTSPACE(0)
 MARGINS(1,61)
 /TITLE=  LEFT 'sample_MICS using WHO Child Growth Standards'
 /VARIABLES
...
Report
  ...
  PAGE(1) MISSING'.' LENGTH(1, 99999)ALIGN(LEFT) TSPACE(0) FTSPACE(0)
 MARGINS(1,63)   /TITLE= LEFT 'sample_MICS using WHO Child Growth Standards'  /VARIABLES
 htagesd  'ht/ageSD'  'N'  (RIGHT)  (OFFSET(0)) (8)
 $dummy01 (DUMMY)  'ht/ageSD'  '< -3'  (RIGHT)  (OFFSET(0)) (8)
 $dummy02 (DUMMY)  'ht/ageSD'  '< -2'  (RIGHT)  (OFFSET(0)) (8)
 $dummy03 (DUMMY)  'ht/ageSD'  'Mean'  (RIGHT)  (OFFSET(0)) (8)
...
XSAVE outfile="d:\igrowup\sample_MICS_z.sav" /keep=casenum to zbmi,zwaz,zwhz,whzflag to whznoage.
